...
Функция должна возвращать словарь, который описывает соединения между устройствами, независимо от того
сохраняется ли топология в файл.
...
def generate_topology_from_cdp(list_of_files, save_to_filename=None):
    ...
    for file_cdp in list_of_files:
        with open(file_cdp) as src:
            d.update(parse_sh_cdp_neighbors(src.read()))
    if save_to_filename:
